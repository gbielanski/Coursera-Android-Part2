...
public class DownloaderTaskFragment extends Fragment {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		downloader.execute(bundle.getIntegerArrayList(MainActivity.TAG_FRIEND_RES_IDS));
					...
					new BroadcastReceiver() {
						...
						public void onReceive(Context context, Intent intent) {
							...
							if (this.getResultCode()!=MainActivity.IS_ALIVE) {
								...
								PendingIntent pendingNotify = PendingIntent.getActivity(mContext, MY_NOTIFICATION_ID, restartMainActivityIntent, PendingIntent.FLAG_UPDATE_CURRENT);
